...
pub const COMMANDS: &[Command] = &[
    ...
    Command { name: "goal", detail: "Launch an autonomous end-to-end swarm mission (e.g. /goal Build user auth with JWT)", arity: Arity::Body, arg: ArgSource::None, listed: true },
    Command { name: "loop", detail: "Execute an iterative autonomous loop until a condition or count (e.g. /loop 5 fix compiler errors)", arity: Arity::Body, arg: ArgSource::None, listed: true },
    ...
    Command { name: "brainstorm", detail: "Explore a design before any code (e.g. /brainstorm @Quark the new menu)", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "team-brainstorm", detail: "Kick off brainstorming with the whole team", arity: Arity::Body, arg: ArgSource::None, listed: true },
    Command { name: "writing-plans", detail: "Turn a settled design into an implementation plan", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "executing-plans", detail: "Work through an existing plan, task by task", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "reviewing-work", detail: "Review code changes, plans, or commit diffs", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "dispatching-parallel-agents", detail: "Dispatch 2+ independent parallel tasks across workers", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "finishing-a-development-branch", detail: "Guide branch completion, PRs, merge or cleanup", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "receiving-code-review", detail: "Process and verify code review feedback", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "requesting-code-review", detail: "Request review before completing or merging work", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "subagent-driven-development", detail: "Execute multi-task implementation plan via subagents", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "systematic-debugging", detail: "Investigate bugs, test failures, and unexpected behaviors", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "test-driven-development", detail: "Implement feature or bugfix using test-driven development", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "using-git-worktrees", detail: "Isolate feature work in a dedicated git worktree", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "using-superpowers", detail: "Discover and activate available superpowers/skills", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "verification-before-completion", detail: "Run verification commands before claiming work is complete", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "writing-skills", detail: "Create, edit, or verify custom skill procedures", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "release", detail: "Execute project release procedure in .hadron/nucleus/release.md", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "absorb", detail: "Absorb foreign assistant skills, memories, lessons, rules, and plans into .hadron/", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "security-review", detail: "Audit authentication, permissions, secrets, and injection vectors", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "security", detail: "Audit security boundaries, secrets, and injection vectors", arity: Arity::Body, arg: ArgSource::Quark, listed: false },
    Command { name: "architecture-audit", detail: "Audit component decoupling, SSOT integrity, and type-system invariants", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "arch", detail: "Audit component decoupling, SSOT integrity, and type-system invariants", arity: Arity::Body, arg: ArgSource::Quark, listed: false },
    Command { name: "code-review", detail: "Review code changes, plans, or commit diffs", arity: Arity::Body, arg: ArgSource::Quark, listed: false },
    Command { name: "chaos-testing", detail: "Stress test concurrency races, timeout handling, and edge failure modes", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "chaos-test", detail: "Stress test concurrency races, timeout handling, and edge failure modes", arity: Arity::Body, arg: ArgSource::Quark, listed: false },
    Command { name: "test-engineering", detail: "Stress test concurrency races, timeout handling, and edge failure modes", arity: Arity::Body, arg: ArgSource::Quark, listed: false },
    Command { name: "performance-audit", detail: "Profile CPU/memory allocations, lock contention, and render-loop lag", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "perf-audit", detail: "Profile CPU/memory allocations, lock contention, and render-loop lag", arity: Arity::Body, arg: ArgSource::Quark, listed: false },
    Command { name: "optimize", detail: "Profile CPU/memory allocations, lock contention, and render-loop lag", arity: Arity::Body, arg: ArgSource::Quark, listed: false },
    Command { name: "code-simplification", detail: "Prune dead abstractions, unused types/imports, and reduce complexity", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "simplify", detail: "Prune dead abstractions, unused types/imports, and reduce complexity", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "refactor", detail: "Prune dead abstractions, unused types/imports, and reduce complexity", arity: Arity::Body, arg: ArgSource::Quark, listed: false },
    Command { name: "api-design", detail: "Design type-safe API contracts, wire protocols, and error schemas", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "contract", detail: "Design type-safe API contracts, wire protocols, and error schemas", arity: Arity::Body, arg: ArgSource::Quark, listed: false },
    Command { name: "incident-investigation", detail: "Systematic failure reproduction, log dissection, and post-mortem analysis", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "triage", detail: "Systematic failure reproduction, log dissection, and post-mortem analysis", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "investigate", detail: "Systematic failure reproduction, log dissection, and post-mortem analysis", arity: Arity::Body, arg: ArgSource::Quark, listed: false },
    Command { name: "memory-curation", detail: "Distill lessons into notes/, prune index.md, and update features.md", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    Command { name: "curate-memory", detail: "Distill lessons into notes/, prune index.md, and update features.md", arity: Arity::Body, arg: ArgSource::Quark, listed: false },
    Command { name: "review", detail: "Request peer review on active branch before merge gate", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
    ...
    Command { name: "reboot", detail: "Force-restart a resident quark (e.g. /reboot @Quark or /reboot all)", arity: Arity::Line, arg: ArgSource::Quark, listed: true },
    ...
    Command { name: "toggle", detail: "Park or unpark a quark — keeps the seat, skips its turns (e.g. /toggle @Quark)", arity: Arity::Line, arg: ArgSource::Quark, listed: true },
    ...
    Command { name: "limit", detail: "Set custom energy token limit for a seat (e.g. /limit @Quark 1000000)", arity: Arity::Line, arg: ArgSource::Quark, listed: true },
    Command { name: "reset-energy", detail: "Reset used token ledger for a seat or all (e.g. /reset-energy @Quark or /reset-energy all)", arity: Arity::Line, arg: ArgSource::Quark, listed: true },
    Command { name: "learn", detail: "Pin a lesson into this repo's nucleus (e.g. /learn always run cargo fmt first)", arity: Arity::Body, arg: ArgSource::None, listed: true },
    Command { name: "learn-global", detail: "Pin a lesson into your global nucleus, across every repo", arity: Arity::Body, arg: ArgSource::None, listed: true },
    Command { name: "learn-std-model", detail: "Add a standard law to this repo (appends to laws.md, never edits the Standard Model)", arity: Arity::Body, arg: ArgSource::None, listed: true },
    Command { name: "learn-std-model-global", detail: "Add a standard law across every repo you run Hadron in", arity: Arity::Body, arg: ArgSource::None, listed: true },
    ...
    Command { name: "abandon", detail: "Archive-tag then discard a quark's pending branch (e.g. /abandon @Quark, then /abandon @Quark confirm to force)", arity: Arity::Line, arg: ArgSource::Quark, listed: true },
    ...
    Command { name: "spend", detail: "Show spend per seat over a window: today (session), week, or all (e.g. /spend @Quark week)", arity: Arity::Line, arg: ArgSource::Quark, listed: true },
    ...
    Command { name: "team-review", detail: "Multi-quark peer review board across security, architecture, and simplicity", arity: Arity::Body, arg: ArgSource::Quark, listed: true },
...
pub fn help_body() -> String {
    ...
    for c in COMMANDS.iter().filter(|c| c.listed) {
        let arg = match (c.name, c.arity) {
            (_, Arity::None) => "",
            ("add-skill", Arity::Body) => " <name> (then paste the file content on the following lines)",
            (_, Arity::Line | Arity::Body) => " <…>",
        };
        out.push_str(&format!("- `/{}{}` — {}\n", c.name, arg, c.detail));
    }
    out.push_str(
